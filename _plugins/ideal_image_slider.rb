...
module Jekyll
  class Slider2020Tag < Liquid::Block
    ...
    def render(context)
      ...
      if @slider_height
        ...
        # render the slider
        slider = "<div class=\"twentytwenty-container\" id=\"#{slider_id}\">#{output}</div>"
        slider
      else
        "Error processing input, expected syntax: {% slider2020 height [captions] %}"
...
Liquid::Template.register_tag('slider2020', Jekyll::Slider2020Tag)
# Jekyll Ideal Image Slider v1.2
# Description: Add image sliders to Jekyll with Ideal Image Slider
# Documentation: https://github.com/jekylltools/jekyll-ideal-image-slider#readme
# Source: https://github.com/jekylltools/jekyll-ideal-image-slider
